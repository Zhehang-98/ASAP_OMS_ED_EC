...
rpi5_ec = [111,188,286,398,500,594,662,692,683,709,735,736,774]
rpi5_ed = [0,0,0,0,0,9,38,62,194,248,245,242,238]
qidk_ec = [104,189,286,395,477,583,687,675,758,733,718,720,690]
qidk_ed = [0,0,0,0,0,12,30,71,227,262,308,307,293]
...
offsets_rpi5_ec = [(-3, 10),  (15, -15),  (-10, 10),  (-10, 10),  (-12, 10),  (-12, 10),
                (0, -15),  (0,10),  (0, -15),  (0, -15), (0, 10), (0, 10), (0, 10)]
offsets_qidk_ec = [(3, -15),   (-10, 10),  (15, -15) ,   (15, -15),   (15, -15) , (15, -15),
                (0, 10), (0, -15), (0, 10), (0, 10),  (0, -15), (0, -15), (0, 10)]
offsets_rpi5_ed = [(0, 10),   (0, 10),     (0, 10),     (0, 10),     (0, -15),     (0, -15),
                (0, 10),  (0, -15), (5, -15),    (3, -15),  (0, -15),  (0, -15),   (0, -15)]
offsets_qidk_ed = [(0, -15),   (0, -15),   (0, -15), (0, -15), (0, 10), (0, 10),
                (0, -15), (-5, 10), (-3, 10),    (0, 10), (0, 10),   (0, 10), (0, 10)]
...
# 后半段（虚线）
plt.plot(lambda_comp[split_index:], rpi5_ec_ips[split_index:],
         marker='o', color='red', linestyle='--')
plt.plot(lambda_comp[split_index:], qidk_ec_ips[split_index:],
         marker='s', color='blue', linestyle='--')
plt.plot(lambda_comp[split_index:], rpi5_ed_ips[split_index:],
         marker='o', color='darkgreen', linestyle='--', alpha=0.8)
plt.plot(lambda_comp[split_index:], qidk_ed_ips[split_index:],
         marker='s', color='indigo', linestyle='--', alpha=0.6)
...
plt.text(6.75, 2, 'Breakpoint: λ = 6', fontsize=12, va='center', ha='right', color='gray')
...
plt.ylabel("Images per second", fontsize=16)
plt.legend()
plt.grid(True)
...
# 保存图像
plt.savefig(os.path.join(save_dir, "YOLO_systemthroughput_comparison.png"), bbox_inches='tight')
plt.savefig(os.path.join(save_dir, "YOLO_systemthroughput_comparison.pdf"), bbox_inches='tight')
plt.close()
