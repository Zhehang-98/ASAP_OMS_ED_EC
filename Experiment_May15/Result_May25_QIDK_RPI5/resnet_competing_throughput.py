...
4797,4806,4769]
resnet_rpi5_ed = [0,0,0,0,0,0,0,0,51,218,626,705,737,716,693]
resnet_qidk_ec = [500,1000,1526,1997,2560,3041,
3476,3934,4477,4705,4807,4798,
4834,4787,4869]
resnet_qidk_ed = [0,0,0,0,0,0,0,0,52,225,622,788,815,795,782]
...
offsets_rpi5_ec = [(-10, 8),   (-10, 8),  (15, -14),   (-10, 8) ,  (15, -14) , (15, -14),
                (-10, 8),  (-10, 8),  (-10, 8), (0, 10) , (-4, -15), (0, 20), (4, -15),(0, 10),(0, -15)]
offsets_qidk_ec = [(15, -12),  (15, -12), (-10, 8), (15, -14),   (-10, 8),  (-10, 8),
                (15, -14), (15, -14), (15, -14), (0, -15),  (-4, 10), (0, -25), (4, 7),(0, -15),(0, 10)]
offsets_rpi5_ed = [(-15, 7),   (0, 7),     (0, 7),     (0, 7),     (0, 7),     (0, 7),
                (0, 7), (0, -15), (3, -15),  (0, -15),  (-7, 8), (14, -20),   (13, -15),(13, -15),(13, -15)]
offsets_qidk_ed = [(0, -15),   (0, -15),   (0, -15), (0, -15), (0, -15), (0, -15),
                (0, -15), (0, 7), (3, 7),  (0, 10), (-3, -20),  (-14, 15), (0, 13), (-3, 10),(0, 10)]
...
# 后半段（虚线）
plt.plot(lambda_resnet[split_index:], resnet_rpi5_ec_ips[split_index:],
         marker='o', color='red', linestyle='--')
plt.plot(lambda_resnet[split_index:], resnet_qidk_ec_ips[split_index:],
         marker='s', color='blue', linestyle='--')
plt.plot(lambda_resnet[split_index:], resnet_rpi5_ed_ips[split_index:],
         marker='o', color='darkgreen', linestyle='--', alpha=0.8)
plt.plot(lambda_resnet[split_index:], resnet_qidk_ed_ips[split_index:],
...
plt.text(49.7, 16, 'Breakpoint: λ = 45', fontsize=12, va='center', ha='right', color='gray')
...
# 保存图像
plt.savefig(os.path.join(save_dir, "resnet50_competing_systemrate.png"), bbox_inches='tight')
plt.savefig(os.path.join(save_dir, "resnet50_competing_systemrate.pdf"), bbox_inches='tight')
plt.close()
