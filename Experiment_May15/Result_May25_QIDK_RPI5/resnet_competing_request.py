...
4797,4806,4769]
resnet_rpi5_ed = [0,0,0,0,0,0,0,0,51,218,626,705,1142,1617,2093]
resnet_qidk_ec = [500,1000,1526,1997,2560,3041,
3476,3934,4477,4705,4807,4798,
4834,4787,4869]
resnet_qidk_ed = [0,0,0,0,0,0,0,0,52,225,622,788,1225,1622,2135]
...
plt.text(49.7, 14, 'Breakpoint: λ = 45', fontsize=12, va='center', ha='right', color='gray')
