...
# 数据
lambda_vals = list(range(1, 14))

plt.figure(figsize=(12, 6))

rpi5_power = [0.496235,0.530405,0.537004,0.548001,0.544495,0.8266,
1.361104,1.939111,4.892131,4.070214,3.897855,3.691556,3.481973]
qidk_power = [0.35838,0.343502,0.370996,0.456881,0.429936,0.671804,
1.06913,1.967308,5.383124,5.854677,5.907985,5.828543,5.86478]
# qidk_power = [x / 1000 for x in qidk_power]  # 转换为 W
...
offsets_rpi5 = [(0, 15), (0, 15), (0, 15), (0, 15), (2, 15), (0, 15),
                (-5, 15), (15, -15), (15, 10), (5, 10), (0, 10), (0, 10), (0,10)]
offsets_qidk = [(0, -15), (0, -15), (0, -15), (0, -15), (2, -15), (0, -15),
                (5, -15), (-15, 15), (0, 15), (0, 15), (0, 15), (0, 15), (0, 15),(0, -15)]
...
plt.text(6.75, 4.5, 'Breakpoint: λ = 6', fontsize=12, va='center', ha='right', color='gray')
